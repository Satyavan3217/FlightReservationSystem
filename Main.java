...
public class Main {
    public static void main(String[] args) {
        ...
        Passenger passenger = new Passenger("Satyavan Jamkar","+91 8483974946","satyavanjamkar3217@mail.com",
                                            "JM Road","Pune","Maharashtra");

        // creating regularTicket and touristTicket objects (as mentioned in Project Checkpoints).
        RegularTicket regularTicket = new RegularTicket("1727","Pune","Kolkata",flight,
                "01/01/2021 - 01:20 am IST","01/01/2021 - 01:50 am IST",passenger,35
        ,30000, true, "Food", "7H");

        TouristTicket touristTicket = new TouristTicket("1728","Pune","Mumbai", flight,
